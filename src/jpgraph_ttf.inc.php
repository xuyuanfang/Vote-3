...
define("FF_BIG5",32);
define("FF_SIMSUN_UTF8",33); //声明该常量，注意数字上使用不同的就可以了
...
class TTF {
    ...
    function __construct() {
	    ...
	    FF_ARIAL =>   array(FS_NORMAL =>'arial.ttf',
	    	FS_BOLD  =>'Arial Bold.ttf',
	    	FS_ITALIC =>'Arial Italic.ttf',
	    	FS_BOLDITALIC =>'Arial Bold Italic.ttf' ) ,
	    ...
	    FF_SIMSUN  =>  array(
	    	...
	    	FS_ITALIC =>'',
	    	FS_BOLDITALIC =>'' ),
        FF_SIMSUN_UTF8  =>  array(FS_NORMAL =>'SimSun.ttf',
            FS_BOLD =>'SimHei.ttf',
             FS_ITALIC =>'',
            FS_BOLDITALIC =>''),
	    FF_CHINESE  =>   array(
